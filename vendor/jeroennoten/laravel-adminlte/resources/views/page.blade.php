                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown messages-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="header text-center bg-gray-light"> {{$request->session()->get('contagemDemandasDistribuidasLiquidacao')}} pedido(s) de liquidação</li>
                                <li class="header text-center bg-gray-light"> {{$request->session()->get('contademDemandasDistribuidasAntecipadoCambioPronto')}} pedido(s) de conformidade</li>
                        ...
                        <li class="dropdown messages-menu">
                            <a href="distribuir.php" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="label label-danger">{{$request->session()->get('contagemDemandasCadastradasLiquidacao') + $request->session()->get('contagemDemandasCadastradasAntecipadosCambioPronto')}}</span> &nbsp;
                            </a>
                            <ul class="dropdown-menu">
                                <li class="header text-center bg-gray-light">Gestor, você deve designar:</li>
                                <li class="header text-center bg-gray-light"> {{$request->session()->get('contagemDemandasCadastradasLiquidacao')}} demanda(s) de liquidação.</li>
                                <li class="header text-center bg-gray-light"> {{$request->session()->get('contagemDemandasCadastradasAntecipadosCambioPronto')}} demanda(s) de conformidade.</li>
