...
<br>
    ...
    <hr>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <input class="form-control" name="dataLiquidacao" type="date" placeholder="DD/MM/AAAA">
            </div>

            <label class="col-sm-1 control-label">Número do Boleto:</label>
            <div class="col-sm-1">
                <input class="form-control" name="numeroBoleto" type="number">
            </div>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="radio col-sm-2">
                <label>
                    <input type="radio" name="analiseInvoice" value="conforme">Conforme
                </label>
            </div>
            <div class="radio col-sm-2">
                <label>
                    <input type="radio" name="analiseInvoice" value="inconforme">Inconforme
                </label>
            </div>
            <div class="radio col-sm-2">
                <label>
                    <input type="radio" name="analiseInvoice" value="naoSeAplica">N/A
                </label>
            </div>
        </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" rows="10" name="analiseCeopc" id="observacoes"></textarea>
            </div>
        </div>
    </div>  <!--/col-md-6-->
...
@section('js')
    ...
    <script src="{{ asset('js/contratacao/carrega_lista_arquivos_json.js') }}"></script>
