...
<br>
    ...
    <!-- ########################################## QUADRO Pedidos de Liquidação ################################################ -->
        ...
        <h4>Pedidos de Liquidação <button type='' id="countPedidosLiquidacao" class='btn btn-secondary margin20'>0</button></h4>

<div class="table-responsive">
    <table id="tabelaPedidosLiquidacao" class="table table-striped compact dataTable">
...
<h4>Pedidos de Conformidade (Antecipados) <button type='' id="countPedidosConformidade" class='btn btn-secondary margin20'>0</button></h4>

<div class="table-responsive">

    <table id="tabelaPedidosConformidade" class="table table-striped compact dataTable">
        <thead class="thead-dark">
            <tr>
                <th>Protocolo</th>
                <th>Nome</th>
...
<h4>Pedidos de Contratação <button type='' id="countPedidosContratacao" class='btn btn-secondary margin20'>0</button></h4>

<div class="table-responsive">

    <table id="tabelaPedidosContratacao" class="table table-striped compact dataTable">
        <thead class="thead-dark">
            <tr>
                <th>Protocolo</th>
                <th>Nome</th>
