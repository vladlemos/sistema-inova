...
//         // $("#tabelaLoteAtual").load(this);
//         // atualizaTabelaProxLote();

// //         xmlHttp=new XMLHttpRequest();
// //         $('#tabelaLoteAtual>tbody>tr').innerHTML=xmlHttp.responseText;
// //         xmlHttp.open("GET","../api/bndes/v1/siaf_amortizacoes_lote_atual",true);
// // //         $('#tabelaLoteAtual>tbody>tr').load(data);
// //         contrato = JSON.parse(ctrProx);
// //         linha = $('#tabelaLoteAtual>tbody>tr');
